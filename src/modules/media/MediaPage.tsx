    ...
    <div className="space-y-6">
      <div className="card">
        ...
        <p className="mt-2 text-sm text-[var(--text-soft)]">
          Stream live, watch recorded content, and follow partner-led channels that convert attention into ecosystem action.
        </p>
      </div>
      ...
      <div className="card">
        <div className="aspect-video rounded-2xl border border-[var(--line)] bg-gradient-to-br from-[var(--panel)] to-[color:rgba(220,173,75,0.12)] p-6">
          ...
          <p className="mt-3 max-w-lg text-sm text-[var(--text-soft)]">Replace this container with your streaming provider embed to enable real broadcasts.</p>
        </div>
      </div>
